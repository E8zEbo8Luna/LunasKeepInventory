...
scoreboard objectives add lki.opt_out dummy

execute unless score lose_percentage lki.settings matches 0..100 run scoreboard players set lose_percentage lki.settings 60
